...
<%
	...
	int itemnum = Integer.parseInt(request.getParameter("itemNum")); //리스트에서 받은 아이템넘버 파라미터를 String에서 int 로 변환하여 대입 
...
%>
	...
	<form name="frm" action="/ProTwo/product/selltenderForm.jsp" method="get" onsubmit="return Check()">
		<input type="hidden" name="itemNum" value="<%=dto.getItemNum()%>">
	
		<input type="submit" value="계속해서 판매하기"> <!-- sellPro.jsp로~ -->
